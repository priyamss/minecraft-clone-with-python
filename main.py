...
app = Ursina()
dirt_texture = load_texture('assets/grass_tx .png')
stone_texture = load_texture('assets/stone_tx.png')
brick_texture = load_texture('assets/brick_tx.png')
grass_texture  = load_texture('assets/grass_tx.png')
wood_texture = load_texture("assets/wood_tx.png")
